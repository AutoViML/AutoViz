...
class AutoViz_Class:
    ...
    def AutoViz_Main(self, filename, sep=',', depVar='', dfte=None, header=0, verbose=0,
        ...
        try:
            dft, depVar, IDcols, bool_vars, cats, continuous_vars, discrete_string_vars, date_vars, classes, \
                ...
                if len(continuous_vars) > 0:
                    try:
                        svg_data = draw_scatters(dft,
                                                 continuous_vars, verbose, chart_format, problem_type, depVar, classes,
                                                 lowess, mk_dir)
